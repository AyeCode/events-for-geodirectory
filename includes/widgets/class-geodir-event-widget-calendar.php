...
class GeoDir_Event_Widget_Calendar extends WP_Super_Duper {
	...
	public static function script() {
		...
		function geodir_event_get_calendar($container, params) {
			const $calendar = jQuery('.geodir_event_calendar', $container);
			$calendar.addClass('geodir-calendar-loading');
			const data = `action=geodir_calendar&geodir_nonce=<?php echo esc_js( $nonces['geodir_calendar'] ); ?>${params}${geodir_event_params.calendar_params}`;
