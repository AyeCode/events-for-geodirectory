...
class GeoDir_Event_Schedules {
	...
	public static function event_type_condition( $event_type, $alias = NULL, $date = '' ) {
		...
		$filters = array(
			...
			'next_7_days'   => "( ( {$alias}start_date BETWEEN '" . $date . "' AND '" . $next_7_days . "' ) OR ( {$alias}end_date BETWEEN '" . $date . "' AND '" . $next_7_days . "' ) OR ( '" . $date . "' BETWEEN {$alias}start_date AND {$alias}end_date ) OR ( '" . $next_7_days . "' BETWEEN {$alias}start_date AND {$alias}end_date ) ) ",
			'next_30_days'  => "( ( {$alias}start_date BETWEEN '" . $date . "' AND '" . $next_30_days . "' ) OR ( {$alias}end_date BETWEEN '" . $date . "' AND '" . $next_30_days . "' ) OR ( '" . $date . "' BETWEEN {$alias}start_date AND {$alias}end_date ) OR ( '" . $next_30_days . "' BETWEEN {$alias}start_date AND {$alias}end_date ) ) ",
